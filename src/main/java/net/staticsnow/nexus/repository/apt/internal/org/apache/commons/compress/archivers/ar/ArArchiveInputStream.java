/*
 * NOTE: This file is a copy of an unreleased version of
 * org.apache.commons.compress.archivers.ar.ArArchiveInputStream.java
 * from Apache commons-compress that includes fixes to support proper
 * end of stream detection. This fix is made in commons-compress Git,
 * but is not yet available in a release as of version 1.18 of
 * commons-compress.
 * 
 * It is used under the Apache license, and has been minimally edited
 * to be placed in a different package name.
 * 
 * This file can be removed when a public release of commons-compress
 * includes this fix.
 * 
 * The following attributions are from the NOTICE.txt included with
 * commons-compress:
 * 
...
package net.staticsnow.nexus.repository.apt.internal.org.apache.commons.compress.archivers.ar;
