...
ARG NEXUS_BUILD=02
USER root
RUN mkdir /opt/sonatype/nexus/system/net/staticsnow/ /opt/sonatype/nexus/system/net/staticsnow/nexus-repository-apt/ /opt/sonatype/nexus/system/net/staticsnow/nexus-repository-apt/1.0.4/; \
...
COPY --from=build /nexus-repository-apt/target/nexus-repository-apt-1.0.4.jar /opt/sonatype/nexus/system/net/staticsnow/nexus-repository-apt/1.0.4/
USER nexus
