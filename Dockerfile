...
ARG APT_VERSION=1.0.11
ARG COMP_VERSION=1.18
ARG XZ_VERSION=1.8
ARG APT_TARGET=/opt/sonatype/nexus/system/org/sonatype/nexus/plugins/nexus-repository-apt/${APT_VERSION}/
USER root
